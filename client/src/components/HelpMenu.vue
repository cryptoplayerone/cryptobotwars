    ...
    >
        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <a href="https://github.com/cryptoplayerone/cryptobotwars" target="_blank">Github source code</a>
                ...
                <p class="red">To be able to receive rewards, you need to make sure you have a path from the Game Guardian <span class="font-weight-black">{{gameAddresses.guardian}}</span> to your node, that has enough deposits in the rewards direction. You may need to ask other nodes to open a channel with you and make a deposit, you can ask for help in <a :href="chatUrl" target="_blank" class="white--text">our chat</a>.</p>
